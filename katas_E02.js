...
function updateFinalPrice(car, globalBasePrice) {
  car.finalPrice = car.basePrice + globalBasePrice
  console.log(`Final price updated to ${car.finalPrice}`)
}
updateFinalPrice(car1, globalBasePrice)
updateFinalPrice(car2, globalBasePrice)
